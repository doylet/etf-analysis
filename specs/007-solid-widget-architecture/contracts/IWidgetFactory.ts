...
// Re-export types needed by factory
export { WidgetType } from './IWidgetConfiguration';
export type { IWidgetController } from './IWidgetController';
export type { IDataProvider, DataProviderConfig } from './IDataProvider';
